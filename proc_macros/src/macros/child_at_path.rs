...
use quote::quote;
use crate::outputs::child_at_path::child_at_path_toks;
use crate::{transform_syn_err};
use crate::utils::types::ident_from_litstr::ident_from_literal;
...
struct MacroInput {
    ...
    // singular_term: LitStr,
    // _singular_term_comma: Comma,
    // plural_term: LitStr,
