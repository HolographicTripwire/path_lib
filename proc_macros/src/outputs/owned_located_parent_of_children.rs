...
pub fn owned_located_parent_of_children_toks(bounded_child_type: &TypeWithBounds, path_type: &TypePath, singular_snakecase: &LitStr, plural_snakecase: &LitStr, plural_titlecase: &LitStr) -> TokenStream {
    ...
    quote! {
        ...
        where Parent:#lt + Clone + #parent_of_children<#child_generics>, ParentPath: #lt + Clone {
            ...
            fn #get_children_owned(&#lt self) -> impl IntoIterator<Item = #child_type> where #child_type: Clone { self.self_ref().obj.#get_children_owned() }

            fn #get_located_child(&#lt self, path: #path_type) -> Result<#obj_at_path<#lt,#child_type,JoinedPath>,()> { 
        ...
        impl <#lt,Parent,ParentPath,JoinedPath,#child_generic_bounds> #owned_located_parent_of_children<#lt,Parent,ParentPath,JoinedPath,#child_generics>
        for #owned_obj_at_path<Parent,ParentPath> where Parent:#lt + Clone + #parent_of_children<#child_generics>, ParentPath: #lt + Clone, JoinedPath: From<(ParentPath,#path_type)> {
